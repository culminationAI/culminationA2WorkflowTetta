...
Bootstrap a new project workspace through build-up. Onboarding IS build-up — the coordinator learns about the project through exploration, not static configuration. The workflow starts at version 0.1 and graduates to 1.0 after successful initialization.
...
Phase 8: Build-Up complete. Version → 1.0. Workflow ready.
